...
1. Open **graphHelper.ts** and add the following function.
    ...
    :::code language="typescript" source="./src/user-auth/graphtutorial/graphHelper.ts" id="GetInboxSnippet":::

1. Replace the empty `ListInboxAsync` function in **index.ts** with the following.

    :::code language="typescript" source="./src/user-auth/graphtutorial/index.ts" id="ListInboxSnippet":::
