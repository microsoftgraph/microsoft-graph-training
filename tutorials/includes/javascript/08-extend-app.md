...
1. Open **graphHelper.js** and add the following function.
    ...
    :::code language="javascript" source="./src/user-auth/graphtutorial/graphHelper.js" id="MakeGraphCallSnippet":::

1. Replace the empty `makeGraphCallAsync` function in **index.js** with the following.

    :::code language="javascript" source="./src/user-auth/graphtutorial/index.js" id="MakeGraphCallSnippet":::
...
- To call an API with app-only authentication see the [app-only authentication](/graph/tutorials/javascript-app-only) tutorial.
