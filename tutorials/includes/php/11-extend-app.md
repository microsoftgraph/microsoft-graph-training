...
1. Add the following code to the `GraphHelper` class.
    ...
    :::code language="php" source="./src/demo/graphtutorial/GraphHelper.php" id="MakeGraphCallSnippet":::

1. Replace the empty `makeGraphCall` function in **main.php** with the following.

    :::code language="php" source="./src/demo/graphtutorial/main.php" id="MakeGraphCallSnippet":::
